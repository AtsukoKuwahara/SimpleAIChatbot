...
struct ChatView: View {
    ...
    let models = ["llama3.1", "llama3.2", "mistral"]
        ...
        NavigationView {
            ZStack {
                ...
                VStack(alignment: .leading) {
                    ...
                    ScrollView {
                        if !isLoading && !responseMessage.description.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
                    ...
                    .opacity(isLoading ? 0 : 1) // Hide response while loading
                    Spacer()
                }
                .padding()
